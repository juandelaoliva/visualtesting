...
const duplicate_action_guardian_1 = __importDefault(require("./duplicate-action-guardian"));
const menu_buttons_1 = __importDefault(require("./menu-buttons"));
const menu_responders_1 = __importDefault(require("./menu-responders"));
...
class TelegrafInlineMenu {
    ...
    replyMenuMiddleware() {
        const obj = {
            middleware: () => (ctx) => __awaiter(this, void 0, void 0, function* () { return obj.setSpecific(ctx, ''); }),
            setSpecific: (ctx, actionCode) => __awaiter(this, void 0, void 0, function* () {
                if (!obj.setMenuFunc) {
    ...
    pagination(action, additionalArgs) {
        ...
        const pageFromCtx = (ctx) => __awaiter(this, void 0, void 0, function* () {
            const number = Number(ctx.match[ctx.match.length - 1]);
            const totalPages = Math.ceil(yield getTotalPages(ctx));
            return Math.max(1, Math.min(totalPages, number)) || 1;
        });
        this.responders.add({
            middleware: (ctx) => __awaiter(this, void 0, void 0, function* () { return setPage(ctx, yield pageFromCtx(ctx)); }),
            action: this.actions.addDynamic(action),
            hide,
            setMenuAfter: true
        });
        const createPaginationButtons = (ctx) => __awaiter(this, void 0, void 0, function* () {
            if (hide && (yield hide(ctx))) {
                return {};
            }
            // Numbers are within
            // currentPage in [1..totalPages]
            const totalPages = yield getTotalPages(ctx);
            const currentPage = yield getCurrentPage(ctx);
            return pagination_1.paginationOptions(totalPages, currentPage);
        });
        this.buttons.addCreator((ctx) => __awaiter(this, void 0, void 0, function* () {
            const buttonOptions = yield createPaginationButtons(ctx);
    ...
    question(text, action, additionalArgs) {
        ...
        const parseQuestionAnswer = (ctx) => __awaiter(this, void 0, void 0, function* () {
            const answer = ctx.message.text;
            yield setFunc(ctx, answer);
        });
        this.responders.add({
            hide,
            setMenuAfter: true,
        ...
        const hitQuestionButton = (ctx) => __awaiter(this, void 0, void 0, function* () {
    ...
    select(action, options, additionalArgs) {
        ...
        this.responders.add({
            middleware: (ctx) => __awaiter(this, void 0, void 0, function* () { return setFunc(ctx, keyFromCtx(ctx)); }),
            action: this.actions.addDynamic(action),
    ...
    toggle(text, action, additionalArgs) {
        ...
        const hideFunc = (ctx, state) => __awaiter(this, void 0, void 0, function* () {
            if (hide && (yield hide(ctx))) {
                return true;
            }
            const isSet = yield isSetFunc(ctx);
            return isSet === state;
        });
        this.button((ctx) => __awaiter(this, void 0, void 0, function* () { return prefix_1.prefixEmoji(text, false, additionalArgs, ctx); }), `${action}-true`, Object.assign({}, additionalArgs, { doFunc: (ctx) => __awaiter(this, void 0, void 0, function* () { return setFunc(ctx, true); }), hide: (ctx) => __awaiter(this, void 0, void 0, function* () { return hideFunc(ctx, true); }) }));
        this.button((ctx) => __awaiter(this, void 0, void 0, function* () { return prefix_1.prefixEmoji(text, true, additionalArgs, ctx); }), `${action}-false`, Object.assign({}, additionalArgs, { doFunc: (ctx) => __awaiter(this, void 0, void 0, function* () { return setFunc(ctx, false); }), hide: (ctx) => __awaiter(this, void 0, void 0, function* () { return hideFunc(ctx, false); }) }));
        return this;
    }
    ...
    generate(ctx, actionCode, options) {
        return __awaiter(this, void 0, void 0, function* () {
            options.log('generate…', actionCode.get());
            const text = typeof this.menuText === 'function' ? yield this.menuText(ctx) : this.menuText;
            ...
            const keyboardMarkup = yield this.buttons.generateKeyboardMarkup(ctx, actualActionCode, options);
            options.log('buttons', keyboardMarkup.inline_keyboard);
            const extra = telegraf_1.Extra.markdown().markup(keyboardMarkup);
            return { text, extra };
        });
    }
    setMenuNow(ctx, actionCode, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const { text, extra } = yield this.generate(ctx, actionCode, options);
            const photo = typeof this.menuPhoto === 'function' ? yield this.menuPhoto(ctx) : this.menuPhoto;
            ...
            if (ctx.updateType !== 'callback_query' || isPhotoMessage !== Boolean(photo)) {
                ...
                if (photo) {
                    yield ctx.replyWithPhoto(photo, photoExtra);
                }
                else {
            ...
            try {
                ...
                if (photo) {
                    ...
                    yield ctx.editMessageMedia(media, photoExtra);
                }
                else {
    ...
    middleware(actionCode, options) {
        ...
        const setMenuFunc = (ctx, reason, actionOverride) => __awaiter(this, void 0, void 0, function* () {
            if (actionOverride) {
        ...
        if (this.commands.length > 0) {
            ...
            functions.push(myComposer.command(this.commands, (ctx) => __awaiter(this, void 0, void 0, function* () { return setMenuFunc(ctx, 'command'); })));
        }
        for (const replyMenuMiddleware of this.replyMenuMiddlewares) {
            ...
            replyMenuMiddleware.setMenuFunc = (ctx, actionOverride) => __awaiter(this, void 0, void 0, function* () {
        ...
        const handlerFuncs = this.submenus
            ...
            const hiddenFunc = (ctx, next) => __awaiter(this, void 0, void 0, function* () {
    ...
    _selectPagination(baseAction, optionsFunc, additionalArgs) {
        ...
        if (setPage && getCurrentPage) {
            this.pagination(`${baseAction}Page`, {
                setPage,
                getCurrentPage,
                getTotalPages: (ctx) => __awaiter(this, void 0, void 0, function* () {
